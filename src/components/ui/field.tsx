...
const fieldBase =
  "w-full rounded-[calc(var(--radius)-0.35rem)] border border-input bg-card px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-60";
...
>(({ className, children, ...props }, ref) => (
  <select
    ref={ref}
    className={cn(fieldBase, "h-10 appearance-none bg-[length:1.1rem] pr-9", className)}
    style={{
      backgroundImage:
